...
$MESS["REGISTER_EMAIL_WILL_BE_SENT"] = "Указывайте реальный адрес электронной почты. На указанный в форме e-mail придет запрос на подтверждение регистрации.";
$MESS["REGISTER_EMAIL_WAS_SENT"] = "На указанный в форме e-mail выслан запрос на подтверждение регистрации.";
