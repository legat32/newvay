...
// Корректуры In-Marketing (Наумов)
...
// Сформируем дополнительные параметры
	foreach($arResult["ITEMS"] as $key=>$arElement) {
		...
		$arResult["ITEMS"][$key]["DETAIL_PAGE_URL"] = $GLOBALS["arDetailPageURL"][$arElement["ID"]];
		//pra($GLOBALS["arDetailPageURL"][$arElement["ID"]]);
		}


//pra($GLOBALS["arDetailPageURL"]);



// Далее что было по дефолту
