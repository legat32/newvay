...
<p>Для оформления заказа Вам необходимо авторизоваться или зарегистрироваться.</p>

<table class="order-auth" width="100%">
	<tr>
				...
				<table class="sale_order_full_table" >
					...
					<tr>
						<td nowrap align="center">
							<input type="submit" value="<?echo GetMessage("STOF_NEXT_STEP")?>" style="margin:10px 0;">
		...
		<td>
			<?if($arResult["AUTH"]["new_user_registration"]=="Y"):?>
				<form method="post" action="" name="order_reg_form">
					<?=bitrix_sessid_post()?>
					<input type="hidden" name="NEW_LOGIN" size="30" value="<?=randString(10)?>">
					<?
					foreach ($arResult["POST"] as $key => $value)
					{
					?>
					...
					<table class="sale_order_full_table">
						...
						<tr>
							<td nowrap>
								Город <span class="starrequired">*</span><br />
								<input type="text" name="NEW_CITY" size="40" value="<?=$arResult["AUTH"]["NEW_CITY"]?>">&nbsp;&nbsp;&nbsp;
							</td>
						</tr
						<tr>
							<td nowrap>
								Телефон <span class="starrequired">*</span><br />
								<input type="text" name="NEW_PHONE" size="40" value="<?=$arResult["AUTH"]["NEW_PHONE"]?>">&nbsp;&nbsp;&nbsp;
							</td>
						</tr>
						<tr>
							<td nowrap>
						...
						<tr>
							<td align="center">
								<input type="submit" value="<?echo GetMessage("GOTO_REG")?>" style="margin:10px 0;">
