...
foreach($arResult['ITEMS'] as $k=>$arElement) {
	...
	$new[$arElement["PROPERTIES"]["COLLECTION"]["VALUE"]][] = Array(
		"ID" => $arElement["ID"],
		"NAME" => $arElement["NAME"],
		...
		"PREVIEW_IMG" => CFile::ResizeImageGet($arElement["DETAIL_PICTURE"], array('width'=>200, 'height'=>300), BX_RESIZE_IMAGE_PROPORTIONAL, true)
		);
	}
...
$arResult["SLIDES"] = $new1;


$arSects = Array();
$dbSection = CIBlockSection::GetList(array(), array("IBLOCK_ID" => $arParams["IBLOCK_ID"]), false, array("CODE", "NAME", "SECTION_PAGE_URL"));
while($arSection = $dbSection->GetNext())
{
	$arSects[strtoupper($arSection["CODE"])] = Array(
		"NAME" => $arSection["NAME"],
		"SECTION_PAGE_URL" => $arSection["SECTION_PAGE_URL"]
		);
}

$arResult["SLIDES_SECTS_DATA"] = $arSects;
