...
<div class="<?=(($isFilter || $isSidebar) ? "col-md-9 col-sm-8 col-sm-pull-4 col-md-pull-3" : "col-xs-12")?>">
	...
	<?
	$sortedByPriceAsc = $_GET["sort"] == "price_asc" ? "active" : "";
	$sortedByPriceDesc = $_GET["sort"] == "price_desc" ? "active" : "";
	
	$sortedByCount15 = $_GET["count"] == 15 || empty($_GET["count"]) ? "active" : "";
	$sortedByCount30 = $_GET["count"] == 30 ? "active" : "";
	$sortedByCount60 = $_GET["count"] == 60 ? "active" : "";
	
	if($_GET["count"] == 15) $arParams["PAGE_ELEMENT_COUNT"] = 15;
	if($_GET["count"] == 30) $arParams["PAGE_ELEMENT_COUNT"] = 30;
	...
	<div class="row selectors">
		<div class="col-xs-8 left sort">
			Сортировка: 
			<a title="По возрастанию цены" class="<?=$sortedByPriceAsc?>" href="<?=$APPLICATION->GetCurPageParam("sort=price_asc", array("sort"))?>">по цене<i class="fa fa-angle-up"></i></a> 
			<a title="По убыванию цены" class="<?=$sortedByPriceDesc?>" href="<?=$APPLICATION->GetCurPageParam("sort=price_desc", array("sort"))?>">по цене<i class="fa fa-angle-down"></i></a>
		</div>
		<div class="col-xs-4 right count">
			Показывать по: 
			<a class="<?=$sortedByCount15?>" href="<?=$APPLICATION->GetCurPageParam("", array("count"))?>">15</a>
			<a class="<?=$sortedByCount30?>" href="<?=$APPLICATION->GetCurPageParam("count=30", array("count"))?>">30</a>
