		...
		?><li id="<?=$this->GetEditAreaId($arSection['ID']);?>">
			<?if($arSection["DEPTH_LEVEL"]==1):?>
				<?if(is_array($arSection["PICTURE"])):?>
					<div class="sect_img"><a href="<?=$arSection["SECTION_PAGE_URL"]?>"><img width="<?=$arSection["PICTURE"]["WIDTH"]?>" height="<?=$arSection["PICTURE"]["HEIGHT"]?>" src="<?=$arSection["PICTURE"]["SRC"]?>"/></a></div>
				<?else:?>
