				...
				<div class="bx_my_order">
					...
					<table class="bx_my_order_table">
						...
						<tbody>
							<tr>
								<td>
									<span class="price"><?/*?><?=GetMessage('SPOL_PAY_SUM')?>:</strong> <?*/?><?=$order["ORDER"]["FORMATED_PRICE"]?></span><br />
									...
									*/?>
									...
									<span class="basket-count">Количество наименований товаров: <?=count($order["BASKET_ITEMS"])?></span>
									<?/*?>
								...
								<td>
									...
									<?/*?>
									<div class="bx_my_order_status <?=$arResult["INFO"]["STATUS"][$order["ORDER"]["STATUS_ID"]]['COLOR']?>"><?=$arResult["INFO"]["STATUS"][$order["ORDER"]["STATUS_ID"]]["NAME"]?></div>
