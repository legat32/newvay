...
<div class="item_wrapper">
	<div class="item_images">
		...
		<?if($arResult["PROPERTIES"]["RASPRODAZHA"]["VALUE"]=="true"):?><div class="item_sale"></div><?endif?>
		<?if(is_array($arResult["DETAIL_IMG"])):?>
			<div class="item_img">
				<a class="fancybox" rel="group1" href="<?=$arResult["ORIGINAL_IMG"]["src"]?>"><img class="item_detail_img" width="<?=$arResult["DETAIL_IMG"]["width"]?>" height="<?=$arResult["DETAIL_IMG"]["height"]?>" src="<?=$arResult["DETAIL_IMG"]["src"]?>"></a>
			</div>
		<?else:?>
				...
				<div class="wrap">
					<div class="frame" id="centered" style="overflow: hidden;">
						<ul class="clearfix" style="-webkit-transform: translateZ(0px) translateX(-2964px); width: 6840px;">
							...
							<li class=""><a class="fancybox" rel="group1" href="<?=$photo["ORIGINAL"]["src"]?>"><img src="<?=$photo["SRC"]?>"/></a></li>
							<?endforeach?>
						</ul>
					</div>
				</div>
...
<?
$GLOBALS["arrFilterOther"] = Array("IBLOCK_ID"=>14, "!ID"=>$arResult["ID"]);
?>
