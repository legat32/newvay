	...
	switch ($arParams['VIEW_MODE'])
	{
		...
		case 'TEXT':
			foreach ($arResult['SECTIONS'] as &$arSection)
			{
				...
				?><li id="<? echo $this->GetEditAreaId($arSection['ID']); ?>"<?if($arSection["CODE"]==$arParams["SECTION_CODE"]):?> class="active"<?endif?>><span class="bx_catalog_text_title"><a href="<? echo $arSection['SECTION_PAGE_URL']; ?>"><? echo $arSection['NAME']; ?></a><?
				if ($arParams["COUNT_ELEMENTS"])
				{
					?> <span><? echo $arSection['ELEMENT_CNT']; ?></span><?
				}
