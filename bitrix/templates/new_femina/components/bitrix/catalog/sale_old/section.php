...
if($ar_sort[0] == "price") $element_sort_field = "catalog_PRICE_".PRICE_TYPE;
...
<tr>
	<td align="left">
		Сортировка: &nbsp;&nbsp;по цене <a class="price_desc<?if($sort=="price_desc"):?>_active<?endif?>" href="<?=$APPLICATION->GetCurPageParam("sort=price_desc", Array("view", "sort", "count"))?>" rel="nofollow" title="вниз"></a> <a class="price_asc<?if($sort=="price_asc"):?>_active<?endif?>" href="<?=$APPLICATION->GetCurPageParam("sort=price_asc", Array("view", "sort", "count"))?>" rel="nofollow" title="вверх"></a> 
		&nbsp;&nbsp;&nbsp;по артикулу: <a class="artikul_desc<?if($sort=="artikul_desc"):?>_active<?endif?>" href="<?=$APPLICATION->GetCurPageParam("sort=artikul_desc", Array("view", "sort", "count"))?>" rel="nofollow" title="вниз"></a> <a class="artikul_asc<?if($sort=="artikul_asc"):?>_active<?endif?>" href="<?=$APPLICATION->GetCurPageParam("sort=artikul_asc", Array("view", "sort", "count"))?>" rel="nofollow" title="вверх"></a>
	</td>
	<td align="right">
...
<?$GLOBALS["arrFilter"]["PROPERTY_RASPRODAZHA"]="true";?>
...
if (CModule::IncludeModule("iblock") && COption::GetOptionString("eshop", "catalogSmartFilter", "Y", SITE_ID)=="Y")
{
	...
	<?$APPLICATION->IncludeComponent("bitrix:catalog.smart.filter", "my_smart_filter", Array(
