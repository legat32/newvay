...
$MESS['SOA_TEMPL_ORDER_SUC2'] = "Если Вы ранее не отправляли копии документов, то для получения счета для оплаты и заключения договора поставки необходимо прикрепить копии документов в <a href=\"/personal/\">Личном кабинете</a>. После получения документов, менеджер вышлет счет с реквизитами для оплаты на ваш e-mail";
