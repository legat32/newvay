	...
	<div class="bx_item_container">
		<div class="bx_lt">
			<div class="bx_item_slider" id="<? echo $arItemIDs['BIG_SLIDER_ID']; ?>">
				...
				<?if($arResult["PROPERTIES"]["AKTSIYA"]["VALUE"] == "true"):?>
					<a class="item_aktsiya" title="Акция!"></a>
				<?endif?>
				
				<?if(($arResult["PROPERTIES"]["AKCIYA_ON_SITE"]["VALUE"] == "Y")&&($arResult["MIN_PRICE"]["DISCOUNT_DIFF"]>0)):?>
					<a class="item_akciya_on_site" title="Акция!"></a>
					<?$arParams['SHOW_DISCOUNT_PERCENT'] = "N";?>
				<?endif?>
				
				<?$arDiscount = CCatalogDiscount::GetByID(11);?>
				<?if($arDiscount["ACTIVE"] == "Y"):?>
					<span class="black-friday" title="Black Friday!"></span>
				<?endif?>
		...
		<div class="bx_rt">
			...
			$values_count = 0;
			foreach($arResult["SKU_PROPS"]["COLOR_LIST"]["VALUES"] as $val)
			...
			?>
				<div class="<? echo $strClass; ?>" id="<? echo $arItemIDs['PROP'].$arProp['ID']; ?>_cont">
					...
					<?if($arProp["CODE"] == "SIZE_LIST"):?>
						<a class="get_size fancybox-iframe" href="/razmery/razmery_popup.php">Определить свой размер</a>
						<a class="get_size_min" href="/razmery/">Определить свой размер</a>
					<?endif?>
					
					<div class="bx_size_scroller_container<?if($arProp["CODE"] == "COLOR_LIST"):?> scrollbar-rail<?endif?>">
						<div class="bx_size">
