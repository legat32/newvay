...
<p align="right"><a href="<?=$_SERVER["HTTP_REFERER"]?>" rel="nofollow">Назад</a></p>



<?if( ( (defined("DEALER_USER"))||(defined("JOINT_USER")) )&&($totalCount < 10)):?>
	<p class="note">Перед оформлением заказа просьба внимательно ознакомиться с условиями <a href="/partneram/">сотрудничества</a></p>
<?endif?>
