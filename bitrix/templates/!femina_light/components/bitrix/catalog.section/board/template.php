	...
	<div id="<?=$this->GetEditAreaId($arElement['ID']);?>">
		<div class="item_cell">
			...
			<div class="item_body">
				...
				<?if($arElement["PROPERTIES"]["NOVIZNA"]["VALUE"] == "Новинка"):?><a title="Новинка" class="item_new_sm" href="<?=$arElement["DETAIL_PAGE_URL"]?>">Новинка!</a><?endif?>
				<?if($arElement["PROPERTIES"]["NOVIZNA"]["VALUE"] == "Распродажа"):?><a title="Распродажа" class="item_sale_sm" href="<?=$arElement["DETAIL_PAGE_URL"]?>"></a><?endif?>
				...
				<?if($arElement["PROPERTIES"]["NOVINKA"]["VALUE"]=="true"):?><a class="item_new_sm" href="<?=$arElement["DETAIL_PAGE_URL"]?>">Новинка!</a><?endif?>
				<?if($arElement["PROPERTIES"]["UTSENKA"]["VALUE"]=="true"):?><a class="item_utsenka_sm" href="<?=$arElement["DETAIL_PAGE_URL"]?>">%</a><?endif?>
				<?if($arElement["PROPERTIES"]["AKCIYA_ON_SITE"]["VALUE"]=="Y"):?><a class="item_akciya_on_site_sm" href="<?=$arElement["DETAIL_PAGE_URL"]?>"></a><?endif?>
				<?if($arElement["PROPERTIES"]["BAMBOO"]["VALUE"]=="true"):?><a title="Узнать про уникальные свойства трикотажа из бамбукового полотна" class="item_bamboo_sm" href="/stati/unikalnye-svoystva-trikotazha-iz-bambukovogo-volokna.html?back=<?=urlencode("/search/?q=".strval($_GET["q"]))?>"></a><?endif*/?>
				
				<?if(is_array($arElement["PREVIEW_IMG"])):?>
				<?
					// странный баг именно в этом шаблоне, заменяем пробелы в адресе картинки на %20 
					$arElement["PREVIEW_IMG"]["SRC"] = str_replace(" ", "%20", $arElement["PREVIEW_IMG"]["SRC"]);
					//pra($arElement["PREVIEW_IMG"]["SRC"]);
				?>
				<div class="item_img">
