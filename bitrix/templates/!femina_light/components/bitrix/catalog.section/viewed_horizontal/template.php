...
<?if(count($arResult["ITEMS"])>0):?>
	...
	<div class="sly-section">
		<div class="wrap_section">
			<div class="wrap">
				<div class="frame" id="sly-section-centered-2" style="overflow: hidden;"> 
					<ul class="clearfix" style="-webkit-transform: translateZ(0px) translateX(-2964px); width: 6840px;">
						...
						<li class="">
							...
							<div class="item_cell">
								...
								<?endif?>
								<!--<div class="item_price"><?=CurrencyFormat($item["CATALOG_PRICE_".PRICE_TYPE], "RUB");?></div>-->
...
<?
//pra(PRICE_TYPE == JOINT_PRICE ? "JOINT" : "DEALER");
//pra($arResult);
?>
