...
if(isset($_REQUEST["sort"])) {
	$APPLICATION->set_cookie("sort", strVal($_REQUEST["sort"]), 64); 
...
//pra("sort=".$sort);
//pra("element_sort_field=".$element_sort_field);
//pra("element_sort_order=".$element_sort_order);
//pra("count=".$count);

$arParams["ELEMENT_SORT_FIELD"] = $element_sort_field;
$arParams["ELEMENT_SORT_ORDER"] = $element_sort_order;
$arParams["PAGE_ELEMENT_COUNT"] = $count;
//phpinfo();
?>
			...
			<div class="sort-wrap">
				...
				<div class="catalog-show">
					...
					<span class="show-value">
						...
						<a class="prod_show_number<?if($count=="64"):?>_active<?endif?>" href="<?=$APPLICATION->GetCurPageParam("count=64", Array("view", "sort", "count"))?>" rel="nofollow">64</a>
					</span>
				</div>
			</div>
