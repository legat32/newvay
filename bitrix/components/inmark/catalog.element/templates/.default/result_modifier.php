...
$boolNewCurrencyFormat = false;
if ($arResult['MODULES']['currency'])
{
	$boolNewCurrencyFormat = method_exists('CCurrencyLang', 'CurrencyFormat');
}
...
if ($arResult['CATALOG'] && isset($arResult['OFFERS']) && !empty($arResult['OFFERS']))
{
	...
	foreach ($arResult['OFFERS'] as $keyOffer => $arOffer)
	{
		...
		if (1 === $arOffer['CATALOG_MEASURE_RATIO'])
		{
			$arOffer['RATIO_PRICE'] = array(
				'VALUE' => $arOffer['MIN_PRICE']['VALUE'],
				'DISCOUNT_VALUE' => $arOffer['MIN_PRICE']['DISCOUNT_VALUE'],
				'PRINT_VALUE' => $arOffer['MIN_PRICE']['PRINT_VALUE'],
				'PRINT_DISCOUNT_VALUE' => $arOffer['MIN_PRICE']['PRINT_DISCOUNT_VALUE'],
				'DISCOUNT_DIFF' => $arOffer['MIN_PRICE']['DISCOUNT_DIFF'],
				'PRINT_DISCOUNT_DIFF' => $arOffer['MIN_PRICE']['PRINT_DISCOUNT_DIFF'],
				'DISCOUNT_DIFF_PERCENT' => $arOffer['MIN_PRICE']['DISCOUNT_DIFF_PERCENT'],
		...
		{
			$arOffer['RATIO_PRICE'] = array(
				'VALUE' => $arOffer['MIN_PRICE']['VALUE']*$arOffer['CATALOG_MEASURE_RATIO'],
				'DISCOUNT_VALUE' => $arOffer['MIN_PRICE']['DISCOUNT_VALUE']*$arOffer['CATALOG_MEASURE_RATIO'],
				'CURRENCY' => $arOffer['MIN_PRICE']['CURRENCY']
			);
			$arOffer['RATIO_PRICE']['PRINT_VALUE'] = (
				$boolNewCurrencyFormat
				? CCurrencyLang::CurrencyFormat($arOffer['RATIO_PRICE']['VALUE'], $arOffer['RATIO_PRICE']['CURRENCY'], true)
				: CurrencyFormat($arOffer['RATIO_PRICE']['VALUE'], $arOffer['RATIO_PRICE']['CURRENCY'])
			);
			$arOffer['RATIO_PRICE']['PRINT_DISCOUNT_VALUE'] = (
				$boolNewCurrencyFormat
				? CCurrencyLang::CurrencyFormat($arOffer['RATIO_PRICE']['DISCOUNT_VALUE'], $arOffer['RATIO_PRICE']['CURRENCY'], true)
				: CurrencyFormat($arOffer['RATIO_PRICE']['DISCOUNT_VALUE'], $arOffer['RATIO_PRICE']['CURRENCY'])
			);
			if ($arOffer['MIN_PRICE']['VALUE'] == $arOffer['MIN_PRICE']['DISCOUNT_VALUE'])
			{
				$arOffer['RATIO_PRICE']['DISCOUNT_DIFF'] = 0;
				$arOffer['RATIO_PRICE']['DISCOUNT_DIFF_PERCENT'] = 0;
				$arOffer['RATIO_PRICE']['PRINT_DISCOUNT_DIFF'] = (
					$boolNewCurrencyFormat
					? CCurrencyLang::CurrencyFormat(0, $arOffer['RATIO_PRICE']['CURRENCY'], true)
					: CurrencyFormat(0, $arOffer['RATIO_PRICE']['CURRENCY'])
				);
			}
			else
			{
				$arOffer['RATIO_PRICE']['DISCOUNT_DIFF'] = $arOffer['RATIO_PRICE']['VALUE'] - $arOffer['RATIO_PRICE']['DISCOUNT_VALUE'];
				$arOffer['RATIO_PRICE']['DISCOUNT_DIFF_PERCENT'] = 100*$arOffer['RATIO_PRICE']['DISCOUNT_DIFF']/$arOffer['RATIO_PRICE']['VALUE'];
				$arOffer['RATIO_PRICE']['PRINT_DISCOUNT_DIFF'] = (
					$boolNewCurrencyFormat
					? CCurrencyLang::CurrencyFormat($arOffer['RATIO_PRICE']['DISCOUNT_DIFF'], $arOffer['RATIO_PRICE']['CURRENCY'], true)
					: CurrencyFormat($arOffer['RATIO_PRICE']['DISCOUNT_DIFF'], $arOffer['RATIO_PRICE']['CURRENCY'])
				);
			}
		}
...
{
	if (1 === $arResult['CATALOG_MEASURE_RATIO'])
	{
		$arResult['RATIO_PRICE'] = array(
			'VALUE' => $arResult['MIN_PRICE']['VALUE'],
			'DISCOUNT_VALUE' => $arResult['MIN_PRICE']['DISCOUNT_VALUE'],
			'PRINT_VALUE' => $arResult['MIN_PRICE']['PRINT_VALUE'],
			'PRINT_DISCOUNT_VALUE' => $arResult['MIN_PRICE']['PRINT_DISCOUNT_VALUE'],
			'DISCOUNT_DIFF' => $arResult['MIN_PRICE']['DISCOUNT_DIFF'],
			'PRINT_DISCOUNT_DIFF' => $arResult['MIN_PRICE']['PRINT_DISCOUNT_DIFF'],
			'DISCOUNT_DIFF_PERCENT' => $arResult['MIN_PRICE']['DISCOUNT_DIFF_PERCENT'],
	...
	{
		$arResult['RATIO_PRICE'] = array(
			'VALUE' => $arResult['MIN_PRICE']['VALUE']*$arResult['CATALOG_MEASURE_RATIO'],
			'DISCOUNT_VALUE' => $arResult['MIN_PRICE']['DISCOUNT_VALUE']*$arResult['CATALOG_MEASURE_RATIO'],
			'CURRENCY' => $arResult['MIN_PRICE']['CURRENCY']
		);
		$arResult['RATIO_PRICE']['PRINT_VALUE'] = (
			$boolNewCurrencyFormat
			? CCurrencyLang::CurrencyFormat($arResult['RATIO_PRICE']['VALUE'], $arResult['RATIO_PRICE']['CURRENCY'], true)
			: CurrencyFormat($arResult['RATIO_PRICE']['VALUE'], $arResult['RATIO_PRICE']['CURRENCY'])
		);
		$arResult['RATIO_PRICE']['PRINT_DISCOUNT_VALUE'] = (
			$boolNewCurrencyFormat
			? CCurrencyLang::CurrencyFormat($arResult['RATIO_PRICE']['DISCOUNT_VALUE'], $arResult['RATIO_PRICE']['CURRENCY'], true)
			: CurrencyFormat($arResult['RATIO_PRICE']['DISCOUNT_VALUE'], $arResult['RATIO_PRICE']['CURRENCY'])
		);
		if ($arResult['MIN_PRICE']['VALUE'] == $arResult['MIN_PRICE']['DISCOUNT_VALUE'])
		{
			$arResult['RATIO_PRICE']['DISCOUNT_DIFF'] = 0;
			$arResult['RATIO_PRICE']['DISCOUNT_DIFF_PERCENT'] = 0;
			$arResult['RATIO_PRICE']['PRINT_DISCOUNT_DIFF'] = (
				$boolNewCurrencyFormat
				? CCurrencyLang::CurrencyFormat(0, $arResult['RATIO_PRICE']['CURRENCY'], true)
				: CurrencyFormat(0, $arResult['RATIO_PRICE']['CURRENCY'])
			);
		}
		else
		{
			$arResult['RATIO_PRICE']['DISCOUNT_DIFF'] = $arResult['RATIO_PRICE']['VALUE'] - $arResult['RATIO_PRICE']['DISCOUNT_VALUE'];
			$arResult['RATIO_PRICE']['DISCOUNT_DIFF_PERCENT'] = 100*$arResult['RATIO_PRICE']['DISCOUNT_DIFF']/$arResult['RATIO_PRICE']['VALUE'];
			$arResult['RATIO_PRICE']['PRINT_DISCOUNT_DIFF'] = (
				$boolNewCurrencyFormat
				? CCurrencyLang::CurrencyFormat($arResult['RATIO_PRICE']['DISCOUNT_DIFF'], $arResult['RATIO_PRICE']['CURRENCY'], true)
				: CurrencyFormat($arResult['RATIO_PRICE']['DISCOUNT_DIFF'], $arResult['RATIO_PRICE']['CURRENCY'])
			);
		}
	}
	$arResult['MIN_PRICE'] = $arResult['RATIO_PRICE'];
	unset($arResult['RATIO_PRICE']);
}
