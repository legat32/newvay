$(document).ready( function() {
	...
	if($(".input_PERSONAL_PHONE").size() > 0) $(".input_PERSONAL_PHONE").mask("(hhhh) 999-99-99",{placeholder:"*"});
	if($("input[name=UF_INN]").size() > 0) $("input[name=UF_INN]").mask("9999999999?99",{placeholder:"*"});
	if($("input[name=UF_FIZ_INN]").size() > 0) $("input[name=UF_FIZ_INN]").mask("9999999999?99",{placeholder:"*"});
	...
	$("input[name=register_submit_button]").on("click", function() {
