...
if($arRes = $dbRes->GetNext()) $sectionID = $arRes["IBLOCK_SECTION_ID"];
//echo "<h1>==".$ElementID."==</h1>";
//$GLOBALS["arrFilterOther"] = Array("IBLOCK_ID"=>6, "SECTION_ID" => $sectionID, "!ID" => $ElementID);
$GLOBALS["arrFilterOther"] = Array("IBLOCK_ID"=>6, "SECTION_ID" => $sectionID);
?>
...
<?
$t = explode("/", substr($_SERVER["REQUEST_URI"], 1));
unset($t[count($t)-1]);
$href = "/".implode($t, "/")."/";
?>
<p style="text-align:right;"><a href="<?=$href?>">Назад в каталог</a></p>