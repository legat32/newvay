$(document).ready(function() {
	...
	$(".all_variants").on("click", function(event) {
		//alert("123");
		event.preventDefault();
		$(this).parent().prev(".bx_filter_container_title").click();
		});
	...
	$(".color_var").on( "click", function() {
		//alert('ert');
		//alert($(this).closest("span").find("input").attr("id"));
		$(this).closest("span").find("input").click();
