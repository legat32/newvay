...
if($USER->isAuthorized()) 
{
	...
	// удаляем неиспользуемого типа плательщика
	//if(($arUser["UF_PARTNER_TYPE"] == 19)||($arUser["UF_PARTNER_TYPE"] == 20)) unset($arResult["PERSON_TYPE"][1]);
	//if($arUser["UF_PARTNER_TYPE"] == 21) unset($arResult["PERSON_TYPE"][2]);
	...
	//$arResult["PERSON_TYPE"][2]["CHECKED"] = "N";
	...
	*/
	...
	$(document).ready( function() {
		<?if($arUser["UF_PARTNER_TYPE"] == 21):?>
		$("input#PERSON_TYPE_1").click();
		<?endif?>
		});
	</script>
